...
cd
wget https://raw.githubusercontent.com/ianexec/FINALIZED/main/tools.sh &> /dev/null
chmod +x tools.sh 
yes "" | bash tools.sh
sudo apt install at -y >/dev/null 2>&1

wget -q -O /etc/port.txt "https://raw.githubusercontent.com/ianexec/FINALIZED/main/port.txt"
...
apt install rclone
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://github.com/ianexec/FINALIZED/raw/main/rclone.conf"
...
SETUP_OHPSERV() {
wget https://raw.githubusercontent.com/ianexec/FINALIZED/main/websocket_engine/ohp.sh && chmod +x ohp.sh && yes "" | ./ohp.shh
clear
}

menu() {
wget https://raw.githubusercontent.com/ianexec/FINALIZED/main/HandlerSentry/install_menu.sh && chmod +x install_menu.sh && yes "" | ./install_menu.sh
clear
}
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/ianexec/FINALIZED/main/versi  )
