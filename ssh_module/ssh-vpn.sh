...
<html>
<kepala>
<meta http-equiv="REFRESH" content="0;url=https://wa.me/6283197765857">
</kepala>
<tubuh>
<p>Pengalihan URL</p>
</tubuh>
...
# install badvpn
cd
wget -O /usr/sbin/badvpn "${REPO}ssh_module/badvpn" >/dev/null 2>&1
chmod +x /usr/sbin/badvpn > /dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn1.service "${REPO}ssh_module/badvpn1.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn2.service "${REPO}ssh_module/badvpn2.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn3.service "${REPO}ssh_module/badvpn3.service" >/dev/null 2>&1
...
wget -q -O /etc/default/dropbear "${REPO}ssh_module/dropbear"
wget -q -O $(which dropbear) "${REPO}ssh_module/coredb"
...
wget -O /etc/squid/squid.conf "${REPO}ssh_module/squid3.conf"
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/ianexec/FINALIZED/ssh_module/main/haproxy.cfg"
...
<p style="text-align: center;">
    <span style="color: #41A85F; font-size: 26px;"><strong>LUNATIC TUNNELING</strong></span>
...
<p style="text-align: center;">
    <span style="font-family: 'Trebuchet MS', Helvetica, sans-serif;">
        <span style="color: #E25041; background-color: #61BD6D;">Bandung Barat || Indonesia</span>
        <span style="background-color: #61BD6D;">&nbsp;</span>
    </span>
</p>
<p style="text-align: center;">
    <span style="color: #B8312F;">Telp/WhatsApp</span>:
    <span style="color: #EFEFEF;">6283197765857</span>
</p>
END
